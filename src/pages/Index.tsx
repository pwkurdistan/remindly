    ...
    <div className="min-h-screen bg-gradient-primary flex flex-col items-center justify-between px-6 py-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-20">
        <svg width="100%" height="200" viewBox="0 0 1440 200" className="absolute top-1/3">
          ...
          />
          <path
            d="M0,120 Q360,70 720,120 T1440,120"
            fill="none"
            stroke="white"
            strokeWidth="2"
          />
          <path
            d="M0,140 Q360,90 720,140 T1440,140"
            fill="none"
            stroke="white"
            strokeWidth="2"
          />
      ...
      <div className="z-10 w-full max-w-md mx-auto animate-fade-in">
        <Button
          ...
          size="lg"
          className="w-full h-16 text-lg rounded-full bg-white/20 hover:bg-white/30 text-white border-2 border-white/30 backdrop-blur-sm shadow-glow transition-all duration-300 hover:scale-105"
        >
